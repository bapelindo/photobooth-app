...
<head>
    ...
    <style>
        /* CSS styles remain the same as your provided file */
        ...
        .main-container { width: 100%; max-width: 1100px; opacity: 0; animation: contentFadeIn 0.5s ease-in 0.2s forwards; transition: opacity 0.3s ease-out; }
        ...
        .carousel-wrapper { position: relative; width: 100%; max-width: 82vw; margin: 0 auto; }
        .packages-container { display: flex; overflow-x: auto; scroll-behavior: smooth; -ms-overflow-style: none; scrollbar-width: none; padding: 20px; clip-path: inset(0 0 0 0); }
        .packages-container::-webkit-scrollbar { display: none; }
        .package-card { flex: 0 0 280px; margin-right: 2vw; background-color: #FFFFFF; border: 2px solid #333; border-radius: 15px; padding: 1.5vw; box-shadow: 6px 6px 0px #333; transition: all 0.3s ease; text-align: left; }
        .package-card:last-child { margin-right: 0; }
        .package-card:hover { box-shadow: 9px 9px 0px #FFD166; }
        ...
        .carousel-buttons { text-align: center; margin-top: 20px; }
        .nav-btn { background-color: #FFD166; border: 2px solid #333; border-radius: 50%; width: 60px; height: 60px; font-size: 30px; font-family: 'Fredoka One', cursive; color: #333; cursor: pointer; box-shadow: 3px 3px 0 #333; transition: all 0.2s ease; margin: 0 10px; }
        .nav-btn:hover { transform: scale(1.05); box-shadow: 5px 5px 0 #333; }
        .nav-btn:active { transform: scale(1.05); box-shadow: none; }
        ...
        .popup-content { background-color: #fff; padding: 30px; border-radius: 15px; box-shadow: 0 5px 25px rgba(0,0,0,0.2); text-align: center; max-width: 400px; width: 90%; font-family: 'Poppins', sans-serif; }
        .popup-content p { font-size: 1.1rem; color: #333; margin: 0 0 20px 0; }
        #close-popup-btn { font-family: 'Fredoka One', cursive; font-size: 1rem; background-color: #FFD166; color: #333; padding: 10px 25px; border: 2px solid #333; border-radius: 50px; cursor: pointer; transition: all 0.2s ease; }
        #close-popup-btn:hover { background-color: #ffc84a; }
    </style>
</head>
<body>
            ...
            <div class="packages-container">
                <?php foreach ($packages as $package): ?>
                    <div class="package-card">
                        ...
                        <ul>
                            <li><b><?= $package->frame_count; ?>x</b> Photostrip (Total <b><?= $package->photo_limit ?></b> Foto)</li>
                            <li>Sesi <b><?= $package->session_time_limit / 60; ?> Menit</b></li>
                            <li>Maksimal <b><?= $package->photo_shot_limit; ?></b> Kali Jepret</li>
                        </ul>
    ...
    <script>
        // All JavaScript from your original file remains the same
